...
$sql_agendamentos = "SELECT
                    ...
                    WHERE
                        o.id_Usuario = ?"; // Filtra pelo usuário logado (pessoaJuridica)
...
$sql_orcamentos = "SELECT
                    ...
                    WHERE
                        of.id_Usuario = ? -- Filtra pelo usuário logado (pessoaJuridica)
                    GROUP BY
...
<div class="button-container">
    <button onclick="window.location.href='../../login/admJuridica.php'">Voltar</button>
</div>

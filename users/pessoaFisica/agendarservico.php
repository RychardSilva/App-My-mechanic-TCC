...
$cidades = [];
$sql = "SELECT DISTINCT cidade FROM endereco WHERE cidade IS NOT NULL AND cidade != ''";
            ...
            <div class="filter-container">
                ...
                <select id="cidade" name="cidade" onchange="filterByCity()">
                    ...
                    foreach ($cidades as $cidade) {
                        $selected = (isset($_GET['cidade']) && $_GET['cidade'] == $cidade) ? 'selected' : '';
            ...
            <table id="servicesTable">
                ...
                <tbody>
                    ...
                    if (!empty($selectedCity)) {
                        $query .= " AND endereco.cidade = '$selectedCity'";
                    }
